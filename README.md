...
#### Advanced Knowledge graph embeddings topics 
         ...
         -For example, when we have a knowledge graph, it  does not have negative facts. Using caligration you can go testing in a way that the probability calibration is going 
         plot like a diagonal. A model with the calibrated probabilties is better to clasify.
